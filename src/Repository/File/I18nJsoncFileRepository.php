...
class I18nJsoncFileRepository extends AbstractI18nFileRepository
{
    /**
     * @var FormatJson
     */
    ...
    public function buildFileSource(string $lang, string $group) : I18nFileSourceInterface
    {
        ...
        $fileSource = [
            'filepath' => $this->langDir . '/' . $filepath . '.jsonc',
            //
            'lang'     => $langObject,
            'group'    => $groupObject,
        ];
    ...
    public function loadPoolItemsFromFile(I18nFileSourceInterface $fileSource) : array
    {
        ...
        $choicesArray = $this->formatJson->jsonc_decode([], $content, true);
    ...
    public function saveChoicesArrayToFile(I18nFileSourceInterface $fileSource, array $choicesArray) : bool
    {
        ...
        $content = $this->formatJson->json_print([], $choicesArray);
